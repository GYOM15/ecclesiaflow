...
public class ApiClient {
    ...
    private String basePath = "https://api.churchmanagement.com/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.churchmanagement.com/v1",
      "Production Server",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://staging.churchmanagement.com/v1",
      "Staging Server",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.churchmanagement.com/v1
